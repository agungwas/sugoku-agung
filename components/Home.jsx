...
export default function Home (props) {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: "center" }}>      
      ...
      <RadioForm radio_props={difficulty} initial={difficulty.findIndex(el => el.value === level)} onPress={handleDifficult} formHorizontal={true} labelStyle={{ marginRight: 10, fontSize: 20 }} buttonColor='blue' style={{ marginBottom: 20 }} />
